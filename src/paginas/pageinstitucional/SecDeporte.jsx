...
const SecDeporte = () => {
  const deporte = [
    { nombre: "Camila Herrera", cargo: "Secretaría de Deportes (Titular)", img: null },
    { nombre: "Nicolás Ríos", cargo: "Secretaría de Deportes (Suplente)", img: null },
  ];
  ...
  return (
    <section>
      <h1 className="text-2xl font-bold text-[#00527A] mb-6 ml-10 font-sans">SECRETARÍA DE DEPORTES</h1>
      <div className="max-w-screen-xl mx-auto p-5 space-y-16">
        ...
        <div className="bg-white rounded-xl p-5 lg:p-10">
          ...
          {renderIntegrantes(deporte, "lg:grid-cols-2")}
        </div>
