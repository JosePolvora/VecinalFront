...
const SecComunicacion = () => {
  const comunicacion = [
    { nombre: "Mauro Vega", cargo: "Secretaría de Comunicación (Titular)", img: null },
    { nombre: "Laura Pérez", cargo: "Secretaría de Comunicación (Suplente)", img: null },
  ];
  ...
  return (
    <section>
      <h1 className="text-2xl font-bold text-[#00527A] mb-6 ml-10 font-sans">SECRETARÍA DE COMUNICACIÓN</h1>
