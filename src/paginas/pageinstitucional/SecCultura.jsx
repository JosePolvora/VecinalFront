...
const SecCultura = () => {
  const cultura = [
    { nombre: "Alicia Fernández", cargo: "Secretaría de Cultura (Titular)", img: null },
    { nombre: "Carlos Pereyra", cargo: "Secretaría de Cultura (Suplente)", img: null },
  ];
  ...
  return (
    <section>
      <h1 className="text-2xl font-bold text-[#00527A] mb-6 ml-10 font-sans">SECRETARÍA DE CULTURA</h1>
      <div className="max-w-screen-xl mx-auto p-5 space-y-16">
        ...
        <div className="bg-white rounded-xl p-5 lg:p-10">
          ...
          {renderIntegrantes(cultura, "lg:grid-cols-2")}
        </div>
