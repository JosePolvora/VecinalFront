...
const FormularioReclamos = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center p-6 sm:p-10">
      <div className="flex flex-col md:flex-row justify-center items-start w-full max-w-6xl gap-10 md:gap-20">
        {/* Formulario a la izquierda */}
        <div className="bg-gradient-to-b from-[#002c73] via-[#004c99] to-[#66a3ff] p-6 sm:p-10 w-full md:w-3/5 shadow-xl backdrop-blur-md rounded-2xl">
          <form onSubmit={handleSubmit} className="text-white space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <option value="Recolección de escombros">
        ...
        <div className="bg-gradient-to-b from-[#002c73] via-[#004c99] to-[#66a3ff] p-6 rounded-2xl shadow-2xl border border-gray-200 w-full md:w-auto max-w-xs mx-auto md:mx-0">
