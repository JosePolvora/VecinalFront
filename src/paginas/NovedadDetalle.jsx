...
//   return (
//     <>
//       <h2 className="text-3xl font-bold text-[#002c73] text-center mb-10 uppercase">
//         Actualidad Barrial
//       </h2>

//       <div className="max-w-6xl mx-auto px-4 py-10 flex flex-col md:flex-row gap-8">
//         {/* Contenido principal */}
//         <div className="md:w-2/3 bg-white shadow-xl rounded-2xl p-8 animate-fade-in">
//           {/* Fecha */}
...
//         {/* Sidebar derecho */}
//         <aside className="md:w-1/3 pl-8 p-6 border-l-2 border-gray-400 animate-fade-in">
