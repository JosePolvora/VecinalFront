...
const Historial = () => {
    ...
    const reclamosFiltrados = reclamos.filter((rec) =>
        `${rec.nombres} ${rec.apellido}`.toLowerCase().includes(filtroNombre.toLowerCase())
    );

    const indexOfLastItem = currentPage * itemsPerPage;
    const indexOfFirstItem = indexOfLastItem - itemsPerPage;
    const currentItems = reclamosFiltrados.slice(indexOfFirstItem, indexOfLastItem);
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <div className="mb-6 flex justify-end">
                            <input
                                ...
                                className="px-4 py-2 rounded-xl bg-white text-[#002c73] placeholder:text-[#002c73]/60 shadow-md w-full max-w-[200px]"
                            />
                        </div>
