...
//       <div className="bg-gradient-to-b from-[#002c73] via-[#004c99] to-[#66a3ff] rounded-2xl p-6 sm:p-10 w-full max-w-6xl shadow-xl backdrop-blur-md">
//         <form
...
//           {error && (
//             <p className="text-center text-sm mt-2 text-red-400 font-semibold">
//               {error}
//             </p>
//           )}
...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* <div className="w-1/2 hidden md:block relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10 px-8">
          <div className="text-white text-center space-y-4 animate-fade-in drop-shadow-lg">
            <h1 className="text-4xl font-bold text-blue-100 animate-pulse">
              ¡Bienvenido!
            </h1>
          </div>
        </div>
      ...
      {/* <div className="w-1/2 hidden md:block relative overflow-hidden border-4 border-blue-500 animate-pulse rounded-xl">
  <img
    src={algarrobo}
    alt="Login visual"
    className="w-full h-full object-cover scale-100 hover:scale-110 transition-transform duration-[3000ms] brightness-75"
  ...
  <div className="absolute inset-0 flex items-center justify-center z-10 px-8">
    <div className="text-white text-center space-y-4 animate-fade-in drop-shadow-lg">
      <h1 className="text-4xl font-bold text-blue-100 animate-pulse">¡Bienvenido!</h1>
    </div>
  </div>
</div> */}
