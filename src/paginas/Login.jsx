...
export default function Login({ onLogin }) {
  ...
  const [mostrarClave, setMostrarClave] = useState(false); // <-- Estado para mostrar/ocultar
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* LADO DERECHO - Login */}
      <div className="w-full md:w-1/2 flex justify-center items-start bg-white/20 backdrop-blur-lg p-6">
        <form
