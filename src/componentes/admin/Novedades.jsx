                    ...
                    {loading ? (
                        ...
                        <table className="min-w-full text-sm divide-y divide-white/20 text-white">
                            <thead className="bg-white/10 text-white/80">
                                <tr>
                                    <th className="px-4 py-3 text-left uppercase tracking-wider">Imagen</th>
                                    <th className="px-4 py-3 text-left uppercase tracking-wider">Título</th>
                            ...
                            <tbody className="bg-white/5 divide-y divide-white/10">
                                {novedades.length > 0 ? novedades.map((novedad) => (
                                    <tr className="hover:bg-white/10 transition" key={novedad.id}>
                                        <td className="px-4 py-4 whitespace-nowrap">
                                            {novedad.imagen_url ? (
                                                ...
                                                <span className="italic text-white/60">Sin imagen</span>
                                            )}
                                        </td>
                                        <td className="px-4 py-4 font-semibold">{novedad.titulo}</td>
                                    ...
                                    <tr>
                                        <td colSpan="4" className="text-center py-4 text-white/60">No hay novedades cargadas</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
